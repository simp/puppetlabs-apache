# Class:puppetlabs_apache::params
#
...
# Sample Usage:
#
class puppetlabs_apache::params inherits ::puppetlabs_apache::version {
  if($::fqdn) {
    $servername = $::fqdn
  } else {
    $servername = $::hostname
  ...
  if $::osfamily == 'RedHat' or $::operatingsystem == 'amazon' {
    ...
    $mod_packages         = {
      ...
      'perl'        => 'mod_perl',
      'php5'        => $::puppetlabs_apache::version::distrelease ? {
        '5'     => 'php53',
        default => 'php',
      },
    ...
    $conf_template        = 'puppetlabs_apache/httpd.conf.erb'
    $keepalive            = 'Off'
    ...
    fail("Class['puppetlabs_apache::params']: Unsupported osfamily: ${::osfamily}")
  }
}
