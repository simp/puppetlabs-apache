# Class:puppetlabs_apache::version
#
...
class puppetlabs_apache::version {
  ...
  if ! $distrelease {
    fail("Class['puppetlabs_apache::params']: Unparsable \$::operatingsystemrelease: ${::operatingsystemrelease}")
  }
  ...
  case $::osfamily {
    ...
    default: {
      fail("Class['puppetlabs_apache::version']: Unsupported osfamily: ${::osfamily}")
    }
  }
}
